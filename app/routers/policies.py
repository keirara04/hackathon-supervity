...
LEVER_SCHEMA = [
    ...
    {"key": "min_kb_confidence", "label": "Minimum KB match confidence", "type": "number", "min": 0, "max": 1, "step": 0.05},
    {"key": "min_auto_score", "label": "Minimum auto-resolution score", "type": "number", "min": 0, "max": 1, "step": 0.05},
    ...
    {"key": "major_incident_threshold", "label": "Major incident cluster threshold", "type": "number", "min": 1, "step": 1},
